...
**The distribution that I choose was Linux Kamarada. Their focus is mainly on distribution and documentation of Linux. I agree with their belief that Linux can one day be house hold operating system. In time I think Linux will reach that position once more people start learning and using the system. Linux Kamarada can become the reason for that in due time.**
